...
void display_update(void) {
    ...
    pb = &icon; //whats in here goes on display
    ...
    for(ipage = 0; ipage < 4; ipage++) {        //<4 because 4 is the max number of pages
        ...
        //copy this page of display data
        display_putbuffer(128, *pb);

        //increment pb to next 128 bytes
        pb += 128;
    }
}
